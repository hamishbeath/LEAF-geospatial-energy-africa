...
class Utils:
    ...
    CLOVER RESULTS HEADERS:
    
    'iteration_0_total_system_cost' = total costs for iteration 0
    'iteration_0_total_system_ghgs = total system ghgs for iteration 0
    
    'iteration_1_total_system_ghgs' = system_ghgs_emitted in second iteration
    'iteration_1_total_system_cost' = total system cost for second iteration
    
    'iteration_2_total_system_ghgs' = system_ghgs_emitted in third iteration
    'iteration_2_total_system_cost = total system cost for third iteration
    
    'iteration_2_emissions_intensity' = system emissions intensity of electricity 
    'iteration_2_lcue' = system levelised cost of electricity 
    
    
    CLOVER OPTIMISATION NUMBER KEY
    
    'optimisation_output_1.json' = pv_battery 90% energy met
    'optimisation_output_2.json' = diesel 90% energy met
    'optimisation_output_3.json' = pv_battery grid-level reliability
    'optimisation_output_4.json' = diesel grid-level reliability
